...
#ifndef ASSOICATION_STATE_MACHINE
#define ASSOICATION_STATE_MACHINE
 ...
 */
class AssociationStateMachine : public Object
{
public:
  ...
  virtual ~AssociationStateMachine ();
...
#endif /* ASSOICATION_STATE_MACHINE */
