...
DcfManager::IsBusy (void) const
{
  ...
  if (m_rxing)
    {
//      std::cout << "Rxing" << std::endl;
      return true;
    }
  Time lastTxEnd = m_lastTxStart + m_lastTxDuration;
  if (lastTxEnd > Simulator::Now ())
    {
//      std::cout << "m_lastTxStart=" << m_lastTxStart << std::endl;
//      std::cout << "m_lastTxDuration=" << m_lastTxDuration << std::endl;
//      std::cout << "lastTxEnd=" << lastTxEnd << std::endl;
      return true;
    }
  // NAV busy
  ...
  if (lastNavEnd > Simulator::Now ())
    {
//      std::cout << "m_lastNavStart=" << m_lastNavStart << std::endl;
//      std::cout << "m_lastNavDuration=" << m_lastNavDuration << std::endl;
//      std::cout << "lastNavEnd=" << lastNavEnd << std::endl;
      return true;
    }
  return false;
}
