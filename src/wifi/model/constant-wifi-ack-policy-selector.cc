...
ConstantWifiAckPolicySelector::GetTemporaryParams (Ptr<WifiPsdu> psdu, MacLowTransmissionParameters params)
{
  NS_LOG_FUNCTION (this << psdu << params);
  MacLowTransmissionParameters tempParams = params;
