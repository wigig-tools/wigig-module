...
void
SpectrumWifiPhy::RegisterReportSnrCallback (ReportSnrCallback callback)
{

}

void
SpectrumWifiPhy::ActivateRdsOpereation (uint8_t srcSector, uint8_t srcAntenna,
...
void
SpectrumWifiPhy::ResumeRdsOperation (void)
{

}

void
SpectrumWifiPhy::SuspendRdsOperation (void)
{
